...
const Welcome = ({searchTerm, setSearchTerm, handdleClick}) => {
  const router = useRouter();
  const [activeJobType, setActiveJobType] = useState('Full-time');
  return (
    <View>
      <View style={styles.container}>
      <Text style={styles.userName}>Hello Skhu</Text>
      ...
      <View style={styles.searchWrapper}>
        ...
        <TouchableOpacity style={styles.searchBtn} onPress={handdleClick}>
